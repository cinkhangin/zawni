...
object Converter {
    private val uzRule = arrayListOf(
        "\u1004\u103a\u1039" to "\u1064",
        "\u1039\u1010\u103d" to "\u1096",
        "\u102b\u103a" to "\u105a",
        "\u100b\u1039\u100c" to "\u1092",
        ...
        "\u100f\u1039\u100d" to "\u1091",
        "\u100b\u1039\u100b" to "\u1097",
        "([\u1000-\u1021\u108f\u1029\u1090])([\u1060-\u1069\u106c\u106d\u1070-\u107c\u1085\u108a])?([\u103b-\u103e]*)?\u1031" to "\u1031$1$2$3",
        "\u103c\u103e" to "\u103c\u1087",
    ...
    private val zuRule = arrayListOf(
        "\u200B" to "",
        "(\u103d|\u1087)" to "\u103e",
        "\u103c" to "\u103d",
    ...
    fun uniToZg(input: String): String {
        return convert(uzRule, input)
    }

    fun zgToUni(input: String): String {
        return convert(zuRule, input)
    }

    private fun convert(rule: ArrayList<Pair<String, String>>, input: String): String {
        var output = input
